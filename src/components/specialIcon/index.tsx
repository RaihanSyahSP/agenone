...
const SpecialIcon: React.FC<SpecialIconProps> = ({ icon, title, ...props }) => {
  return (
    <div className="flex flex-col justify-center mx-auto pt-14 pb-10 items-center gap-[10px] md:w-[700px] md:h-[230px]">
        <div className={cn(
